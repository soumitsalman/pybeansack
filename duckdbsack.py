...
class DuckDB(Beansack):
    ...
    def _fetch_all(self, 
        ...
        where_expr, where_params = _where(urls, kind, created, collected, updated, categories, regions, entities, tags, sources, distance, conditions)
...
def _where(
    ...
    if tags: conditions.append("ARRAY_HAS_ANY(tags, ?)"), params.append(tags)
